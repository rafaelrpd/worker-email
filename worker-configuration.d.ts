/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d1243be64fe2474d333bfb8fefc3d366)
...
declare namespace Cloudflare {
    ...
    interface Env {
        DB: D1Database;
        vars: { "ALLOWED_ORIGINS": "__VAR_ALLOWED_ORIGINS__", "RATE_LIMIT_MINUTES": "__VAR_RATE_LIMIT_MINUTES__", "REPLY_PREFIX": "__VAR_REPLY_PREFIX__", "TOKEN_INACTIVITY_DAYS": "__VAR_TOKEN_INACTIVITY_DAYS__", "ALLOWED_REPLY_FROM": "__SECRET_ALLOWED_REPLY_FROM__", "CONTACT_TO": "__SECRET_CONTACT_TO__", "INBOX_TO": "__SECRET_INBOX_TO__" };
        ALLOWED_ORIGINS: string;
        REPLY_PREFIX: string;
        TOKEN_INACTIVITY_DAYS: string;
        RATE_LIMIT_MINUTES: string;
        INBOX_TO: string;
        ALLOWED_REPLY_FROM: string;
        CONTACT_TO: string;
